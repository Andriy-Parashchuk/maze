...
back = transform.scale(image.load("images/background.jpg"), (WIDTH, HEIGHT))
...
player = Player('images/hero.png', WIDTH // 15, HEIGHT - HEIGHT // 5, HEIGHT // 110)
monster = Enemy('images/cyborg.png', WIDTH - WIDTH // 10, HEIGHT - HEIGHT // 3, HEIGHT // 110)

treasure = GameSprite('images/treasure.png', WIDTH - WIDTH // 10, HEIGHT - HEIGHT // 5, 3)
